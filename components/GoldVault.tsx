...
export default function GoldVault() {
  ...
  return (
    <section id="vault" className="py-32 bg-background relative overflow-hidden">
      {/* Decorative blobs */}
      <div className="absolute top-1/4 right-0 w-[500px] h-[500px] rounded-full bg-accent-500/10 blur-[120px] mix-blend-screen pointer-events-none" />
      <div className="absolute bottom-0 left-0 w-[600px] h-[600px] rounded-full bg-primary-500/10 blur-[150px] mix-blend-screen pointer-events-none" />
      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-8 relative z-10 flex flex-col lg:flex-row items-center gap-16 lg:gap-24">
        ...
        >
          ...
          <p className="text-lg text-muted mb-10 leading-relaxed max-w-xl">
            Watch your wealth grow seamlessly. Track real-time gold prices and
            set automated savings goals for your future milestones.
          </p>

          <div className="grid sm:grid-cols-2 gap-6">
            <motion.div
              whileHover={{ y: -5, scale: 1.02 }}
              className="glass-card p-6 rounded-2xl border border-white/5 group flex flex-col items-center text-center"
            >
              <PremiumIcon
                image3d="/icons/chart-3d.png"
                alt="Live Tracking"
                size="lg"
                className="mb-4"
              />
              ...
              <p className="text-sm text-muted">
                Monitor your portfolio with real-time 24K gold market rates.
              </p>
            </motion.div>
            ...
            >
              ...
              <p className="text-sm text-muted">
                Let your daily recharges automatically fund your future goals.
              </p>
            </motion.div>
          </div>
        </motion.div>
        ...
        >
          ...
          <div className="glass-card rounded-[2.5rem] p-8 border border-white/10 shadow-[0_0_50px_rgba(245,158,11,0.15)] relative overflow-hidden">
            {/* Glow inside card */}
            <div className="absolute top-0 right-0 w-64 h-64 bg-gradient-gold opacity-10 blur-[80px]" />
            ...
            <div className="relative z-10">
              ...
              <div className="flex items-end gap-3 mb-2">
                <h3 className="text-5xl font-bold text-white tracking-tight">
                  ₹45,280
                  <span className="text-2xl text-muted">.50</span>
                </h3>
              </div>
              <div className="flex items-center gap-2 mb-8">
                ...
                <span className="text-muted text-sm border-l border-white/20 pl-2">
                  6.25 grams
                </span>
              </div>
              ...
              {/* Goals */}
              <h4 className="text-white font-semibold mb-4 text-sm uppercase tracking-wider text-muted">
                Active Goals
              </h4>
              <div className="space-y-3">
                {[
                  ...
                  <motion.div
                    ...
                    className="flex items-center gap-4 bg-white/5 p-3 rounded-2xl border border-white/5 hover:bg-white/10 transition-colors cursor-pointer group"
                  >
                    <PremiumIcon
                      image3d={goal.image3d}
                      alt={goal.name}
                      size="sm"
